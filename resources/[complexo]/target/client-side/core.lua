...
CreateThread(function()
	...
	AddCircleZone("bankSalary01",vec3(241.34,225.39,106.29),0.75,{
		name = "bankSalary01",
		heading = 3374176
	},{
		distance = 1.5,
	...
	AddCircleZone("bankSalary02",vec3(243.13,224.77,106.29),0.75,{
		name = "bankSalary02",
		heading = 3374176
	},{
		distance = 1.5,
	...
	AddCircleZone("bankSalary03",vec3(246.61,223.52,106.29),0.75,{
		name = "bankSalary03",
		heading = 3374176
	},{
		distance = 1.5,
	...
	AddCircleZone("bankSalary04",vec3(248.34,222.99,106.29),0.75,{
		name = "bankSalary04",
		heading = 3374176
	},{
		distance = 1.5,
	...
	AddCircleZone("bankSalary05",vec3(251.77,221.69,106.32),0.75,{
		name = "bankSalary05",
		heading = 3374176
	},{
		distance = 1.5,
	...
	AddCircleZone("bankSalary06",vec3(253.63,221.07,106.29),0.75,{
		name = "bankSalary06",
		heading = 3374176
	},{
		distance = 1.5,
	...
	AddCircleZone("treatment01",vec3(1831.24,3675.39,34.27),0.75,{
		name = "treatment01",
		heading = 3374176
	},{
		shop = "Sandy",
	...
	AddCircleZone("treatment02",vec3(-675.13,326.4,83.09),0.75,{
		name = "treatment02",
		heading = 3374176
	},{
		shop = "Santos",
	...
	AddCircleZone("treatment03",vec3(-254.21,6331.44,32.42),0.75,{
		name = "treatment03",
		heading = 3374176
	},{
		shop = "Paleto",
	...
	AddCircleZone("tabletVehicles01",vec3(-55.16,-1096.39,26.42),0.75,{
	...
	AddCircleZone("CassinoWheel",vec3(1109.33,229.28,-49.64),0.5,{
		name = "CassinoWheel",
		heading = 3374176
	},{
		distance = 1.5,
					...
					elseif IsPedAPlayer(entity) then
						if #(coords - entCoords) <= 1.0 then
							...
							if IsEntityPlayingAnim(entity,"random@mugging3","handsup_standing_base",3) then
								...
								table.insert(Menu,{ event = "player:runInspect", label = "Revistar", tunnel = "police" })
							end
