...
-- DISCORDHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webHook = "https://discord.com/api/webhooks/1043982090624057435/8CWdmisK0LfNlcyuMWOv6tA3ixNFRPQPv36mJ8BIiBiXLbbhko9Vw1Xc6WsJguABuXz6"
-----------------------------------------------------------------------------------------------------------------------------------------
-- MYSQL
-----------------------------------------------------------------------------------------------------------------------------------------
local mysqlDriver
...
CreateThread(function()
	SetGameType("Atlas Roleplay")
	SetMapName("www.atlas-rp.com")
